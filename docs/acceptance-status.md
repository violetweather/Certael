...
| Rule/profile shadow/canary/approval/rollback | In progress | Signature-verifying immutable in-memory lifecycle stores, distinct approvals, shadow/canary/enforced stages, deterministic assignment, rollback tests | Durable authenticated control-plane APIs, audit linkage, and failure testing |
